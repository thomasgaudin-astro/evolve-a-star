...
def henyey():
    ...
    for j, _ in enumerate(pre_mass_array):
        radj = pre_radius_array[j]
        prej = pre_pressure_array[j]
        lumj = pre_luminosity_array[j]
        temj = pre_temperature_array[j]
        ...
        if j == (len(pre_mass_array)-1):
            ...
            radj1 = pre_radius_array[j+1]
            prej1 = pre_pressure_array[j+1]
            lumj1 = pre_luminosity_array[j+1]
            temj1 = pre_temperature_array[j+1]
